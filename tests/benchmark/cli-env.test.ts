...
import { envNameForPreset, parseArgs as parseBenchmarkArgs } from '../../apps/benchmark/src/index.js';
...
describe('benchmark CLI --context', () => {
  ...
  it('routes the abtest subcommand with control/treatment', () => {
    const a = parseBenchmarkArgs(['abtest', '--control', 'c.jsonl', '--treatment', 't.jsonl', '--dataset', 'd', '--block-size', '50']);
