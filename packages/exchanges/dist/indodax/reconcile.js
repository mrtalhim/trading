...
export function reconcile(input) {
    const unownedOpenOrders = input.openOrders.filter((o) => !isOwnedOrder(o.clientOrderId, input.ownerId));
    ...
    const filledOnExchange = new Set(ownedOpen
    ...
    const missingOnExchange = input.recordedOrders.filter((o) => (o.status === 'open' || o.status === 'partially_filled') &&
